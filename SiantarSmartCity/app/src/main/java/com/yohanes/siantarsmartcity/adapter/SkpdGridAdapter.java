 ...
 */
public class SkpdGridAdapter extends ArrayAdapter<Skpd> {
    Context context;
    ...
    //konstuktor
    public SkpdGridAdapter(Context context, ArrayList<Skpd> skpds) {
        super(context, R.layout.itemgridskpd, skpds);
    ...
    public View getView(int position, View convertView, ViewGroup
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.itemgridskpd, parent,
                    false);
            viewHolder.nama = (TextView)
                    convertView.findViewById(R.id.namaSkpd);
            viewHolder.gambar = (ImageView) convertView.findViewById(R.id.imgSkpd);
