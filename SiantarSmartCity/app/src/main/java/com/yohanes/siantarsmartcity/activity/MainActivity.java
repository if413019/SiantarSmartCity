...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getSupportActionBar().setIcon(R.drawable.logosiantar);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            startActivity(new Intent(this, SelectSkpdActivity.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camara) {
            ...
            if(role.equals(String.valueOf(1)))
            {
                startActivity(new Intent(this, PengaduanSKPD.class));
            }
            else
            {
                startActivity(new Intent(this, PengaduanSaya.class));
            }
    ...
    public void buatPengaduan(View v){
        startActivity(new Intent(this, PilihSkpd.class));
    }

    public void detailSkpd(View v){
        startActivity(new Intent(this, PilihDeskripsiSkpd.class));
    }
