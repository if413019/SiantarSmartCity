...
import com.yohanes.siantarsmartcity.adapter.PengaduanSkpdPager;

public class PengaduanSKPD extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pengaduan_skpd);
        ...
        final PengaduanSkpdPager adapter = new PengaduanSkpdPager
